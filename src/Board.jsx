  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="ml-1 flex h-6 w-6 shrink-0 cursor-pointer items-center justify-center rounded-md text-stone-400 opacity-0 transition hover:text-stone-600 group-hover/mem:opacity-100 max-md:opacity-60"
      >
